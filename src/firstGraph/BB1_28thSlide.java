...
public class BB1_28thSlide extends Variables { //go with Jon
	private String PIC_PATH = "resources/28(Jon).JPG";
	private String FILE_PATH = "resources/texts/BB1_Text.txt";
	...
	Properties butn[] = new Properties[buttonCount];
	{
		...
		butn[2] = new Properties(Variables.calculatePos(23 , true), Variables.calculatePos(30 , false), 30, 30, "   " , arrowPath);
	}
}
