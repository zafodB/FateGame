...
public class AT_TwentiethSlide extends Variables {
	private String PIC_PATH = "resources/18.JPG";
	private String FILE_PATH = "resources/texts/AT_Text.txt";
	...
	{
		butn[0] = new Properties(Variables.calculatePos(3, true), Variables.calculatePos(30, false), 300, 60, ">> exit", super.BUTTON_FONT, false);
