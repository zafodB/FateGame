...
public class BA1_27thSlide extends Variables { // go with Jon
	private String PIC_PATH = "resources/27(Jon).JPG";
	private String FILE_PATH = "resources/texts/BA1_Text.txt";
	...
	Properties butn[] = new Properties[buttonCount];
	{
		...
		butn[1] = new Properties(Variables.calculatePos(27, true),
				Variables.calculatePos(30, false),
				Variables.DEFAULT_BUTTON_WIDTH,
				Variables.DEFAULT_BUTTON_HEIGHT, next, BUTTON_FONT, false);
	}
}
