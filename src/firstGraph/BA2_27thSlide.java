...
public class BA2_27thSlide extends Variables { //go with Yousif
	private String PIC_PATH = "resources/27(Yousif).JPG";
	private String FILE_PATH = "resources/texts/BA2_Text.txt";
	...
	{
		butn[0] = new Properties(Variables.calculatePos(1 , true), Variables.calculatePos(30 , false), Variables.DEFAULT_BUTTON_WIDTH, Variables.DEFAULT_BUTTON_HEIGHT, ">> exit", super.BUTTON_FONT, false);
